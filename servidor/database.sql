...
-- 2. CREACIÓN DE TIPOS ENUM (En Postgres se definen como tipos independientes)
CREATE TYPE user_role AS ENUM ('admin', 'user');
CREATE TYPE order_status AS ENUM ('pendiente', 'pagado', 'enviado');

-- 3. CREACIÓN DE TABLAS (Usamos SERIAL para IDs autoincrementales)
CREATE TABLE teams (
